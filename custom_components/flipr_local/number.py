...
from .const import DOMAIN, CONF_MAC_ADDRESS, CONF_CYA, CONF_SCAN_INTERVAL, get_flipr_model
...
class FliprUpdateIntervalNumber(RestoreNumber):
    """Gère la fréquence de lecture de Home Assistant."""
    ...
    async def async_added_to_hass(self):
        """Appliqué au démarrage (valeur restaurée)"""
