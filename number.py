    ...
    async def async_set_native_value(self, value):
        ...
        if self.coordinator.data:
            ...
            if temp is not None and ph is not None:
                new_data["isl"] = compute_isl(temp, ph, mac_data.get("tac", 0), mac_data.get("th", 0), mac_data.get("tds", 0))
                ...
                new_data["chlore_actif"] = compute_active_chlorine(orp, ph, temp, mac_data.get(CONF_CYA, 40), chlore_model)
