...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback) -> None:
    ...
    async_add_entities([
        ...
        FliprSensor(coordinator, mac_address, "Chlore Actif (HOCl)", "chlore_actif_hocl", None, "mg/L", 2, icon="mdi:pool", model_name=model_name),
        FliprSensor(coordinator, mac_address, "Indice de Langelier", "isl", None, None, 2, icon="mdi:scale-balance", model_name=model_name),
